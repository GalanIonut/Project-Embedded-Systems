...
DRIVER_SOURCES = drivers/gpio/gpio.c drivers/pidparam/pid.c drivers/pwm/pwm.c drivers/timer/timer1.c drivers/timer/timer2.c drivers/adc/adc.c drivers/eeprom/eeprom.c drivers/usart/usart.c
