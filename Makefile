...
CFLAGS += -I. -Idrivers/gpio -Idrivers/interrupt -Idrivers/pid -Idrivers/timer -Idrivers/eeprom -Idrivers/adc -Ibsp -Iutils -Idrivers/usart -Idrivers/pwm -Idrivers/servo -Idrivers/hcsr04 -Idrivers/buzzer
...
# Source Files
SRC = src/main.c drivers/gpio/gpio.c drivers/pid/pid.c drivers/interrupt/external_interrupt.c drivers/timer/timer0.c drivers/timer/timer1.c drivers/timer/timer2.c drivers/usart/usart.c drivers/pwm/pwm.c drivers/eeprom/eeprom.c drivers/adc/adc.c drivers/servo/servo.c drivers/hcsr04/hcsr04.c drivers/buzzer/buzzer.c utils/delay.c
